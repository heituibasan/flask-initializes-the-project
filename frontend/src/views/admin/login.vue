	...
	<a-card :style="backgroundStyle">
		<a-flex justify="center" style="margin-top: 20vh">
			<a-space direction="vertical" size="middle" style="width: 300px">
				...
				><strong>Login</strong></a-typography-title
				>
				...
				/>
				<span>
          <a-typography-link href="/user/register" style="float: left"
          >注册</a-typography-link
          >
          <a-typography-link href="/user/forget" style="float: right"
...
const handleLogin = async () => {
	...
	try {
		...
		// 获取重定向路径
		const redirect = route.query.redirect || "/back/console";
